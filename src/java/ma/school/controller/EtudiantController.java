...
public class EtudiantController extends HttpServlet {
    ...
    int id = Integer.parseInt(request.getParameter("id"));
    Etudiant ne = es.findById(id);
    String nom = ne.getNom();
    String prenom = ne.getPrenom();
    String sexe = ne.getSexe();
    String ville = ne.getVille();  // Add this line
    Date dateNaissance = ne.getDateNaissance();  // Add this line
    RequestDispatcher dispatcher = request.getRequestDispatcher("etudiantForm.jsp");
    request.setAttribute("user", ne);
    request.setAttribute("onom", nom);
    request.setAttribute("oprenom", prenom);
    request.setAttribute("osexe", sexe);
    request.setAttribute("oville", ville);  // Add this line
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    String formattedDate = sdf.format(dateNaissance);
    request.setAttribute("odateNaissance", formattedDate);  // Add this line
    dispatcher.forward(request, response);;
            ...
            ne.setSexe(sexe);
            ne.setVille(ville);
            ne.setDateNaissance(dateNaissance);
            es.update(ne);
            response.sendRedirect("etudiantForm.jsp");
