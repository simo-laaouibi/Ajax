...
public class MachineController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op.equalsIgnoreCase("envoyer")) {
            ...
            Machine ne = mms.findById(id);
            Marque marque = ne.getMarque();
            double prix = ne.getPrix();
            String reference = ne.getReference();
            Date date = ne.getDateAchat();
            RequestDispatcher dispatcher = request.getRequestDispatcher("machineForm.jsp");
            request.setAttribute("machine", ne);
            request.setAttribute("omarque", marque);
            request.setAttribute("oprix", prix);
            request.setAttribute("oreference", reference);  
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            String formattedDate = sdf.format(date);
            request.setAttribute("date", formattedDate);  // Add this line
